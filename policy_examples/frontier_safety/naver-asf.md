...
| Evaluation cycle | Non-existent | Every 3 months, or when performance increases by 6x | To be determined later depending on their future capabilities |
...
|---|---|---|
| Low need for guardrails | Low risk: Deploy AI systems but perform monitoring afterward to manage risks | Risk identified: Open AI systems only to authorized users to mitigate risks |
| High need for guardrails | Risk identified: Withhold deployment until additional safety measures are taken | High risk: Do not deploy AI systems |
